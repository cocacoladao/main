...
const sttaddr = "0x7090187dc637c7ff1f3501c856414f9c9fac12c7";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x7090187dc637c7ff1f3501c856414f9c9fac12c7";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://heineken.finance?ref=' + document.getElementById('refaddress').value;
        }
    }
}
